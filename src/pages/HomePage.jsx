      ...
      <section className="relative rounded-2xl overflow-hidden mb-12">
        ...
        <div className="relative z-20 py-16 md:py-24 px-6 md:px-12 max-w-4xl">
          ...
          <div className="flex flex-wrap gap-4">
            <Link 
              to="/social-feed" 
              className="btn bg-white text-primary-700 hover:bg-gray-100 px-6 py-3 animate-slide-up"
            >
              View Social Feed
            </Link>
            <Link to="/crop-planner" className="btn bg-primary-700/60 backdrop-blur-sm text-white border border-white/30 hover:bg-primary-700/80 px-6 py-3 animate-slide-up">
              Plan Your Crops
            </Link>
          </div>
        </div>
      ...
      <section className="mb-12">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-sm sm:text-base px-4">
            Connect with fellow farmers, share your experiences, and learn from the community. See what's happening in farms across Nepal.
          </p>
        </div>
        ...
        <div className="text-center mt-6 sm:mt-8">
          <Link 
            to="/social-feed" 
            className="btn btn-primary px-6 sm:px-8 py-2 sm:py-3"
          >
